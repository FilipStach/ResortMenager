...
//    @Value("${principle-attribute}")
    private String principleAttribute = "preffered_username";
//    @Value("${resource-id}")
    private String resourceId = "a_resortMenager-rest-api";
    @Override
    ...
    private Collection<? extends GrantedAuthority> extractResourceRoles(Jwt jwt) {
        ...
        if(resourceAccess.get("resortManager-rest-api") == null)
            return  Set.of();
        resource = (Map<String, Object>) resourceAccess.get("resortManager-rest-api");
